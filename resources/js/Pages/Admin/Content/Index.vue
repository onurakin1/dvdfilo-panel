                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input
                                class="form-control"
                                type="file"
                                @change="previewSlider($event, 'tr')"
                                multiple
                            />

                            <div v-if="imageUrls.tr.length" class="mnb">
                                <div
                                    v-for="(url, index) in imageUrls.tr"
                                    :key="index"
                                    class="mt-2 first"
                                >
                                    <div
                                    ...
                                    >
                                        <img
                                            :src="getImageSrc(url, 'tr')"
                                            alt="Preview"
                                            class="img-thumbnail"
                                        />
                                        <div
                                            @click="
                                                deleteImage('tr', index, url)
                                            "
                                            style="color: #000"
                                        >
                                            <span
                        ...
                        <div class="col-lg-6">
                            ...
                            <input
                                class="form-control"
                                type="file"
                                @change="previewSlider($event, 'en')"
                                multiple
                            />
                            <div v-if="imageUrls.en.length" class="mnb">
                                <div
                                    v-for="(url, index) in imageUrls.en"
                                    :key="index"
                                    class="mt-2 first"
                                >
                                    <div
                                    ...
                                    >
                                        <img
                                            :src="getImageSrc(url, 'en')"
                                            alt="Preview"
                                            class="img-thumbnail"
                                        />
                                        <div
                                            @click="
                                                deleteImage('en', index, url)
                                            "
                                            style="color: #000"
                                        >
                                            <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input
                                class="form-control"
                                type="text"
                                v-model="form.en_campaign"
                                placeholder="İngilizce Kampanya Giriniz"
                            />
                        </div>
                    </div>
                    <div
                        v-for="(item, index) in form.carouselItems"
                    ...
                    >
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4 form-group">
                                    ...
                                    <input
                                        class="form-control"
                                        type="text"
                                        v-model="item.badgeTitleTR"
                                        placeholder="Türkçe Başlık"
                                    />
                                </div>
                                <div class="col-lg-4 form-group">
                                    <label
                                        >İngilizce için başlık giriniz:</label
                                    >
                                    <input
                                        class="form-control"
                                        type="text"
                                        v-model="item.badgeTitleEN"
                            ...
                            <div class="row">
                                <div class="col-lg-4 form-group">
                                    ...
                                    <input
                                        class="form-control"
                                        type="text"
                                        v-model="item.badgeDescTR"
                                        placeholder="Türkçe Açıklama"
                                    />
                                </div>
                                <div class="col-lg-4 form-group">
                                    <label
                                        >İngilizce için açıklama giriniz:</label
                                    >
                                    <textarea
                                        class="form-control"
                                        v-model="item.badgeDescEN"
                            ...
                            <div class="row">
                                <div class="col-lg-4 form-group">
                                    <label
                                        >Türkçe için Fiyat açıklaması
                                        giriniz:</label
                                    >
                                    <input
                                        class="form-control"
                                        type="text"
                                        v-model="item.badgePriceTR"
                                        placeholder="Türkçe Fiyat Açıklaması"
                                    />
                                </div>
                                <div class="col-lg-4 form-group">
                                    <label
                                        >İngilizce için Fiyat açıklaması
                                        giriniz:</label
                                    >
                                    <textarea
                                        class="form-control"
                                        v-model="item.badgePriceEN"
                                        placeholder="İngilizce Fiyat Açıklaması"
                                    ></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input
                                class="form-control"
                                type="file"
                                @change="previewReferance($event, 'tr')"
                                multiple
                            />
                        </div>
                        ...
                        <div v-if="refURL.length" class="mnb">
                            ...
                            >
                                ...
                                >
                                    <img
                                        :src="getRefSrc(url, 'tr')"
                                        alt="Preview"
                                        class="img-thumbnail"
                                    />
                                    <div
                                        @click="deleteRefImage(index, url)"
                                        style="color: #000"
                                    >
                                        <span
                                            class="svg-icon svg-icon-primary svg-icon-2x"
...
export default {
    ...
    created() {
        if (this.contents && this.contents.data.length > 0) {
            ...
            this.existingContentOurServices = JSON.parse(
                this.contents.data[0].our_services
            );
            this.existingContentMainSlider = JSON.parse(
                this.contents.data[0].main_slider
            );
            this.existingContentSlider = JSON.parse(
                this.contents.data[0].slider
            );
            this.existingContentReference = this.contents.data[0].reference;
            console.log(this.existingContentReference);
            if (this.existingContentSlider) {
                this.form.en_campaign = this.existingContentSlider.campaign.en;
                this.form.tr_campaign = this.existingContentSlider.campaign.tr;
                this.form.carouselItems = this.existingContentSlider.data.map(
                    (item) => ({
                        ...item,
            ...
            if (this.existingContentOurServices) {
                this.form.our_services_tr =
                    this.existingContentOurServices.tr || "";
                this.form.our_services_en =
                    this.existingContentOurServices.en || "";
            }
            ...
            if (this.existingContentMainSlider) {
    ...
    methods: {
        ...
        async deleteImage(language, index, url) {
            ...
            try {
                await this.$inertia.delete(
                    route("backend.contents.delete", { id: this.form.id }),
                    {
                        preserveState: true,
                        data: {
                            language: language,
        ...
        async deleteRefImage(index, url) {
            ...
            try {
                await this.$inertia.delete(
                    route("backend.contents.refdelete", { id: this.form.id }),
                    {
                        preserveState: true,
                        data: {
                            imageUrl: url,
        ...
        async onFileChange(event, index) {
            ...
            if (file) {
                ...
                this.form.carouselItems[index].previewUrl =
                    URL.createObjectURL(file);
                this.form.carouselItems[index].slide = file;
            } else {
                // If no new file, keep the existing preview URL
                this.form.carouselItems[
                    index
                ].previewUrl = `/uploads/${this.form.carouselItems[index].slide}`;
            }
        },
            ...
            try {
                if (this.form.id) {
                    await this.form.post(
                        route("backend.contents.update", this.form.id),
                        {
                            onSuccess: () => {
                                (this.textMessage =
                    ...
                    await this.form.post(route("backend.contents.create"), {
                        onSuccess: () => {
                            (this.textMessage =
                                "Bilgileriniz başarı ile kaydedildi!"),
                                (this.isModalOpen = true);
                        },
                        onError: () => {
                            console.error("Update failed");
