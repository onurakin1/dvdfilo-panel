        ...
        >
            ...
            >
                ...
                <div class="d-flex align-items-stretch" id="kt_header_nav">
                    <!--begin::Menu wrapper-->
                    <h1 class="mt-5 header-text">Limonist Meta Technology</h1>
                    <!--end::Menu wrapper-->
                </div>
                <!--end::Navbar-->
                <!--begin::Topbar-->
...
export default {
    ...
    methods: {
        role_name(level) {
            return this.__(General.role(level));
        },
    },
    computed: {
        selectable_locale() {
            let languages = this.$page.props.backend_languages;
            let lang = languages.find((l) => l.code == this.$page.props.locale);
